//
// This file is part of "kha2d". <https://github.com/KTXSoftware/Kha2D.git>
//
...
class Sprite {
	...
	public function new(image: Image, width: Int = 0, height: Int = 0, z: Int = 1) {
		...
		spriteRect = new Rectangle(0, 0, this.width, this.height);
		speedx = speedy = 0;
		accx = 0;
		accy = 0.2;
	...
	public function spriteCollider(): Rectangle {
		spriteRect.x = x - collider.x * scaleX;
		spriteRect.y = y - collider.y * scaleY;
